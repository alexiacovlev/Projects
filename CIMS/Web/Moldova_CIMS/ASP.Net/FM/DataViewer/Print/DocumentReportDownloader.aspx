...
<script type="text/javascript">
	function redirect() {
		document.location.href= "DocumentReport.aspx?<%= Request.QueryString %>";
	}
...
To cancel the downloading, click Cancel.
		...
		<tr>
			...
			<br />
				...
				<a style="height:23;width:300px;font-weight:bold" href="DocumentReport.aspx?<%= Request.QueryString %>" onclick="closeOnTimeOut()">Download</a>
			</td>
		</tr>
	</table>
