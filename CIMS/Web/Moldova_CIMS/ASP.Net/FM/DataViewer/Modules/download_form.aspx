...
<head>
	...
	<script type="text/javascript">
		function redirect() {
			window.document.location.href = "download.aspx?<%= Request.QueryString %>";
		}
	...
	<table style="width:99%;" cellpadding="5" cellspacing="5" align="center">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<br />
				<a style="height: 23; width: 300px; font-weight: bold" href="download.aspx?<%= Request.QueryString %>" onclick="closeOnTimeOut()">Download</a>
			</td>
		</tr>
