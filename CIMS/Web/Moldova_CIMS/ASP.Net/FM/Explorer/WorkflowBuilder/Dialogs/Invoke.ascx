	...
	<fieldset class="fm-dlg-sec-bg" style="padding:8px;margin:14px 5px;">
		...
		<table cellpadding="2" cellspacing="2" width="100%">
			...
			<tr>
				...
				<td><select id="listProvider" class="fm"><option value="">Database</option><option value="CODE">Code Data Provider</option><option value="DUMMY">DUMMY</option></select></td>
				<td style="padding-left:10px"><input class="fm" id="tbProvider" style="display:none"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="n" style="padding-left:12px;padding-bottom:0px;"><label>Readonly&nbsp;&nbsp;<input id="cbReadonly" class="fm-chk" type="checkbox" /></label></td>
			</tr>				
		</table>
	</fieldset>
