...
<script language="javascript">
        AX.UM_CreateUserDialog= function ($panel, input, ticket, wnd) {
                ...
                $('#btnCreate', $p).click(function () {
                    var params = parseQueryString(''+$('div.mwnd-hdr').find('span.mwnd-lbl').attr("title"));
                        var data= new Object();
                        ...
                        ExecuteService("{\"data\":"+JSON.stringify(data)+",\"teamid\":\""+(typeof(params["teamid"])  === "undefined"?"":params["teamid"])+"\"}", "/ASP.Net/Modules/CIMS/UserManagement.asmx/CreateUser", Service_OnRegister);
                });
