...
contains addons my Michael Isipciuc - see // ADDED ON
 */
...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElementGeometry: function(rectangle, index, reset) {
			...
			model.width = horizontal? undefined : ipixels.size+(!horizontal?-2:0); // ADDED ON 2017-06-02 by Michael Isipciuc
		},
...
module.exports = function(Chart) {
	...
	Chart.elements.Rectangle = Chart.Element.extend({
		draw: function() {
			...
			// ADDED ON 2017-06-02 by Michael Isipciuc
			// 3d edges
			if (!vm.horizontal) {
				ctx.beginPath();
				ctx.strokeStyle = vm.borderColor;
